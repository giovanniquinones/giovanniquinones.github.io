...
On April 18th, 2025 I finally obtained my Green Card! 

It is an immense relief to finally have this process over with. TO have the freedom to travel, work, and even be unemployed without worrying about my status is priceless.

Given that I submitted my AOS in November 2024, the entire process took about 5 months from start to finish. This is relatively fast compared to the average processing times reported in the USCIS website. It also helped that I wasn't called for an interview. My understanding is that interviews are less common for STEM NIW cases unless you have some red flags in your application. Rumors says under the current adminisrtation interviews are required for all cases, but I can't confirm this.

From now on, I only have to make sure to have my address updated with the USCIS website. 
